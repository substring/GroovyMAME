...
private:
	...
	template <int id, uint16_t _addrstart, uint16_t _addrend>
	class sam_space
	{
	public:
	...
	sam_space<0x0000, 0x7FFF, 0>  m_space_0000;
	sam_space<0x8000, 0x9FFF, 1>  m_space_8000;
	sam_space<0xA000, 0xBFFF, 2>  m_space_A000;
	sam_space<0xC000, 0xFEFF, 3>  m_space_C000;
	sam_space<0xFF00, 0xFF1F, 4>  m_space_FF00;
	sam_space<0xFF20, 0xFF3F, 5>  m_space_FF20;
	sam_space<0xFF40, 0xFF5F, 6>  m_space_FF40;
	sam_space<0xFF60, 0xFFBF, 7>  m_space_FF60;
	sam_space<0xFFE0, 0xFFF1, 8>  m_space_FFE0;
	sam_space<0xFFF2, 0xFFFF, 9>  m_space_FFF2;
